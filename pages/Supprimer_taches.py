...
if "confirm_suppression" not in st.session_state:
    st.session_state.confirm_suppression = False
...
if titre2 and titre2 != "Aucune tâche disponible":
    ...
    if st.button("Supprimer"):
        st.session_state.confirm_suppression = True
    if st.session_state.confirm_suppression:
